  ...
  return (
    <nav className="flex bg-[#1f1934] text-white p-7 justify-between items-center fixed z-10 w-full top-0">
        ...
        <ul className="flex space-x-10 justify-around items-center">
          ...
          <div className=''>
            <a className="bg-black text-white px-4 py-2 rounded hover:bg-gray-200 border-2 hover:text-black border-white transition-all" href="https://wa.me/522228718803" target='_blank'>
              Contáctame
            </a>
          </div>
        </ul>
